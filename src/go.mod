...
require (
	...
	github.com/compose-spec/compose-go v0.0.0-20210826124222-e6bb854d81e9
...
require (
	...
	github.com/distribution/distribution/v3 v3.0.0-20210826081326-677772e08d64 // indirect
