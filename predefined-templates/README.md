...
- `questions` - Lists of quesions, which the cli will ask the user.
	...
	- `default_value` - Default value of the question (Will be displayed in braces after the question)
...
- `volumes` - List of volumes which are used in the compose file
	...
	- `default_value` - Default path on the host system. Relative to the generated compose file
